...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-06-2021 a las 08:20:39
...
(5, 'Curl de bíceps con barra', 'Ejercicio básico para entrenar bíceps, uno de los ejercicios más practicados en la introducción de las personas al ejercicio físico, lo realizaremos de pie y con barra.', 'Manténgase de pie con los pies alineados con los hombros. Sostenga la barra con los brazos ligeramente extendidos y las palmas de las manos hacia arriba, en un agarre supinado.\r\n<br>1- Levante la barra lentamente hasta la altura de los hombros.\r\n<br>2- Vuelva a la posición inicial y repita el movimiento', 'qC0yZwpF9Ew'),
(6, 'Abdominal crunch', 'Uno de los ejercicios más conocidos, esencial para trabajar el abdomen, pero hay que realizarlo de manera correcta para no dañar la espalda. Podemos añadir peso adicional.', 'Se acostará con los pies apoyados en el suelo y las rodillas flexionadas.\r\n<br>1- Levante la parte superior de la espalda hacia las rodillas.\r\n<br>2- Vuelva a la posición inicial y repita el movimiento.', 'OsUz898onTE'),
(7, 'Plancha lateral', 'Ejercicio fundamental para trabajar el abdomen y los oblicuos, difícil de ejecutar correctamente al inicio, pero satisfactorio con una buena ejecución.', 'Acostarse de lado, apoyar el codo en el suelo y mantener las piernas unidas. Apoye la otra mano en la cintura o en la cabeza y levante la cadera.\r\n<br>1- Quédate en esta posición con el abdomen contraído el máximo de tiempo que puedas.\r\n<br>2- Repita el movimiento con el otro lado del cuerpo.', 'zfiOU4yxLKo'),
...
(9, 'Abductores en máquina', 'Ejercicio específico para entrenar abductores, aunque también trabajaremos un poco los glúteos, no confundir con el de aductores.', 'Siéntese en la máquina, con la espalda apoyada y las piernas dentro de las almohadillas laterales.\r\n<br>1- Aleje las piernas, dejándolas lo más lejos posible una de la otra.\r\n<br>2- Vuelva las piernas a la posición inicial hasta que estén casi juntas, y repita el movimiento.', 'A5Bz9bSPKUA'),
...
(15, 'Remo horizontal en polea baja', 'El ejercicio típico de remo para trabajar la espalda, en el que también activaremos los brazos. Con este ejercicio también trabajaremos el cardio y se incluirá por ello en rutinas de perder peso.', 'Siéntese en el asiento, coloque los pies en la plataforma y deje las rodillas ligeramente flexionadas.\r\n<br>1- Tire del peatón hacia el abdomen proyectando los hombros hacia atrás y el pecho hacia adelante. Mantenga la espalda estática, evitando balances.\r\n<br>2- Vuelva a la posición inicial hasta que los brazos queden casi estirados. Deje que los hombros estén ligeramente proyectados hacia adelante y repita el movimiento.', 'P6INB55u7ks'),
...
(1, 'Admin', 0, 'admin', '$2y$10$rmA8vXYkFRpX5PUqER06oenZYyDcXzs3DAk7h1gPcMINvmedVdMii', 'admin@mygymmanagement.es', 1);
...
--
ALTER TABLE `bmi_calc`
  MODIFY `cod_bmi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `routine`
  MODIFY `cod_routine` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `routine_exercise`
  MODIFY `cod_routine_exercise` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `user_routine`
  MODIFY `cod_user_routine` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
COMMIT;
