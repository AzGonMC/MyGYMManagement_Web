...
if(isset($_POST['routine']) && isset($_POST['userRoutine'])) {
    ...
    if(isset($_POST['deleteRoutineExercise'])) {
        Exercise_m::deleteRoutineExercise($_POST['deleteRoutineExercise']);
    }
                ...
                <div class="row">
                    ...
                    <div class="col-4 mx-auto mt-3">
                        <form method="POST" action="routines">
                            <input name="deleteUserRoutine" type="hidden" value="<?= $_POST['userRoutine'] ?>">
                            <input type="submit" value="Eliminar esta rutina" class="btn btn-primary">
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-4 mx-auto my-3">
                        <form method="POST" action="myroutine">
                            <input name="routine" type="hidden" value="<?= $_POST['routine'] ?>">
                            <input name="userRoutine" type="hidden" value="<?= $_POST['userRoutine'] ?>">
                            <input name="deleteRoutineExercise" type="hidden" value="<?= $routineExercise['cod_routine_exercise'] ?>">
