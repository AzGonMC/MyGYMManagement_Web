...
class Exercise_m {
    ...
    public static function deleteRoutineExercise($cod_routine_exercise) {
        $db = new Database();
        $db->consult("DELETE FROM routine_exercise WHERE cod_routine_exercise = '$cod_routine_exercise'");
    }
